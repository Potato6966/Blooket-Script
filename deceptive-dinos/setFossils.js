(async () => {
    ...
    n.remove();
                ...
                if (confirm('Game error occured please report to discord server as soon as possible')) {
                    window.open('https://dsc.gg/potatofam');
                };
            };
})();
...
function footer() {
    ...
    element.innerHTML = `<p>Made by Potato6966🥔 <br> My <a style="color: #0000ff;" href="https://youtube.com/c/MGYT6966" target="_blank">Youtube</a></p>`;
